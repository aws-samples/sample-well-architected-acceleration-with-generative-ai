...
def display_pillar(pillar):
    st.subheader(
        f"Review findings & recommendations for pillar: {pillar['pillar_name']}"
    )
...
def main():
    ...
    selected_analysis = st.selectbox(
        "Select an analysis to view details:", analysis_names
    )
    ...
    if selected_analysis:
        ...
        with wafr_container:
            ...
            tab_names = ["Summary", "Solution Summary"] + [
                f"{pillar['pillar_name']}" for pillar in selected_data["pillars"]
            ]
        ...
        with chat_container:
            ...
            chat_options = ["Summary", "Solution Summary", "Document"] + [
                pillar["pillar_name"] for pillar in selected_data["pillars"]
            ]
        ...
        if prompt:
            ...
            if selected_area == "Summary":
                ...
                pillar_data = next(
                    (
                        pillar
                        for pillar in selected_data["pillars"]
                        if pillar["pillar_name"] == selected_area
                    ),
                    None,
                )
                if pillar_data:
                    ...
                    area_context = (
                        "Error: Selected area not found in the analysis data."
                    )
