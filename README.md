...
cmd to obtain prefix list

```
aws ec2 describe-managed-prefix-lists --query 'PrefixLists[?PrefixListName==`com.amazonaws.global.cloudfront.origin-facing`]' --region ap-southeast-2
```
...
Create VPC connection and open ssh port to in the security group attached to ec2
